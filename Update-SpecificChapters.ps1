# Update specific chapter pages with enhanced styles and Back to Home button

Write-Host "Updating specific chapter pages with enhanced styles and Back to Home button..."
...
function Update-ChapterFile {
    ...
    if ($content -notmatch "enhanced-styles.css") {
        $content = $content -replace '<link rel="stylesheet" href=".*css/styles.css">', '<link rel="stylesheet" href="../../../../css/styles.css">' + "`n    " + '<link rel="stylesheet" href="../../../../css/enhanced-styles.css">'
    }
...
# Process specific chapter files
$chaptersToUpdate = @(
    "courses\english\chapters\a1\a1-chapter1.html",
    "courses\german\chapters\a1\a1-chapter1.html",
    "courses\math\chapters\a1\ch1-basic-arithmetic.html",
    "courses\science\chapters\a1\science-basics.html"
)

foreach ($filePath in $chaptersToUpdate) {
    $fullPath = Join-Path -Path $PSScriptRoot -ChildPath $filePath
    if (Test-Path $fullPath) {
        Update-ChapterFile -filePath $fullPath
    } else {
