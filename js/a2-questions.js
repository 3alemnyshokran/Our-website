// A2 Chapter Interactive Question Handling
document.addEventListener('DOMContentLoaded', function() {
  ...
  const skills = {
    'daily-routine': [
      { q: 'What time do you usually wake up?', a: 'open-ended' },
      { q: 'Which verb is used to describe brushing teeth in the morning routine?', a: 'brush' }
    ],
    'simple-past': [
    ...
    'family': [
      { q: 'What do you call your mother\'s sister?', a: 'aunt' },
      { q: 'What do you call your father\'s father?', a: 'grandfather' }
    ]
  };
  ...
  checkBtn.addEventListener('click', ()=>{
    ...
    if(currentQuestion.a === 'open-ended') {
      ...
      if(ansEl.value.trim().toLowerCase() === correct || 
        ...
        const progressKey = `a2_${currentSkill}_prog`;
